...
public class DriverMaps extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LogoutDriverBtn = (Button) findViewById(R.id.driverlogoutbutton);
        SettingsDriverButton = (Button) findViewById(R.id.settings_client_btn);
        ...
        txtName = findViewById(R.id.name_client);
        txtPhone = findViewById(R.id.phone_client);
        profilePic = findViewById(R.id.profile_image_customer);
        constraintLayout = findViewById(R.id.rel2);
        ...
        AssignedCustomerPickUpRefListner = AssignedCustomerPickUpRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if(dataSnapshot.exists())
                {
                    ...
                    PickUpMarker = mMap.addMarker(new MarkerOptions().position(DriverLatLng).title("Customer PickUp Location").icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_pin)));
                }
            }
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    supportMapFragment.getMapAsync(DriverMaps.this);
                }
            }
        });
    }
    ...
    {
        Intent startPageIntent = new Intent(DriverMaps.this, Welcome.class);
